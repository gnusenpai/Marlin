...
#define STRING_CONFIG_H_AUTHOR "(GNU, Ender-5 SKR Pro 1.1)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 1280, 6400, 1580 }

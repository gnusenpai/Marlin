...
#define STRING_CONFIG_H_AUTHOR "(GNU-Chief, Ender-5 SKR Pro 1.1)" // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, 17.70 } // (mm) relative X-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 1280, 6400, 1580, 1580 }
